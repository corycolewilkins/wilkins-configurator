    ...
    <div className="min-h-screen overflow-x-hidden text-neutral-50">
      <div className="mx-auto max-w-5xl px-3 sm:px-4 py-6 sm:py-10">
        ...
        <div className="mt-6 sm:mt-8 grid gap-4 sm:gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          {/* RIGHT: Summary */}
          <div className="rounded-2xl border-2 border-amber-400/50 bg-transparent p-3 sm:p-4 md:p-5 h-fit sticky top-6 self-start max-h-[calc(100vh-3rem)] overflow-auto">
