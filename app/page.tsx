        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-transparent p-5">
            ...
            <div className="mt-4 grid gap-2">
              ...
              <select
                className="rounded-xl border border-neutral-800 bg-neutral-950/50 px-3 py-2 text-neutral-100 outline-none focus:ring-2 focus:ring-amber-400/40 disabled:opacity-50"
                value={doors || ""}
            ...
            <div className="mt-4 grid gap-3">
              {doorFinishes.map((f, idx) => (
                ...
                >
                  ...
                  <select
                    className="w-full rounded-xl border border-neutral-800 bg-neutral-950/50 px-3 py-2 text-neutral-100 outline-none focus:ring-2 focus:ring-amber-400/40 sm:w-[360px]"
                    value={f}
                    onChange={(e) => {
